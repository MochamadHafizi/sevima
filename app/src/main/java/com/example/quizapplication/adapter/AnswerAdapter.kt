...
import com.example.quizapplication.databinding.ItemAnswerBinding
import com.example.quizapplication.model.Answer

class AnswerAdapter: RecyclerView.Adapter<AnswerAdapter.ViewHolder>() {

    private var answers = mutableListOf<Answer>()

    inner class ViewHolder(private val itemAnswerBinding: ItemAnswerBinding): RecyclerView.ViewHolder(itemAnswerBinding.root) {
        fun binItem(answer: Answer) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binItem(answers[position])
    }
